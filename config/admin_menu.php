...
return [
    ...
    [
        ...
        'routes' => [
            ...
            'admin.tu-van.danh-sach',
        ],
        'route_prefixes' => ['admin.khach-hang.', 'admin.trang-phuc.hop-dong', 'admin.note-khach-moi', 'admin.tu-van.'],
        'label' => 'CRM Khách Hàng',
        'icon' => 'ti tabler-users-group',
        'children' => [
            ['stt' => 1, 'route' => 'admin.khach-hang.danh-sach-hop-dong-cuoi', 'label' => 'DS hợp đồng cưới', 'icon' => 'ti tabler-list-details'],
            ['stt' => 2, 'route' => 'admin.trang-phuc.hop-dong', 'label' => 'DS hợp đồng thuê', 'icon' => 'ti tabler-hanger'],
            ['stt' => 3, 'route' => 'admin.note-khach-moi', 'label' => 'Note khách mới', 'icon' => 'ti tabler-notes'],
            ['stt' => 4, 'route' => 'admin.tu-van.danh-sach', 'label' => 'Tư vấn', 'icon' => 'ti tabler-message-circle'],
        ],
    ],
    [
        'stt' => 4,
        ...
        'route_prefixes' => ['admin.lich-chup', 'admin.lich-shop', 'admin.ca-lam', 'admin.nhan-su.cong-viec-cua-toi'],
        'label' => 'Lịch & Điều phối',
        ...
        'children' => [
            ...
            ['stt' => 3, 'route' => 'admin.ca-lam', 'label' => 'Chia ca làm việc', 'icon' => 'ti tabler-clock'],
            ['stt' => 4, 'route' => 'admin.nhan-su.cong-viec-cua-toi', 'label' => 'Công việc của tôi', 'icon' => 'ti tabler-briefcase'],
        ],
    ],
    [
        'stt' => 5,
        ...
        'routes' => [
            ...
            'admin.diem-danh.diem-danh',
            'admin.diem-danh.cham-cong',
            'admin.diem-danh.nghi-phep',
            'admin.tai-chinh.tinh-luong',
        ],
        'route_prefixes' => ['admin.nhan-su.danh-sach', 'admin.diem-danh.', 'admin.tai-chinh.tinh-luong'],
        'label' => 'Nhân sự',
        'icon' => 'ti tabler-users',
        'children' => [
            ['stt' => 1, 'route' => 'admin.nhan-su.danh-sach', 'label' => 'Danh sách nhân sự', 'icon' => 'ti tabler-users'],
            ['stt' => 2, 'route' => 'admin.diem-danh.diem-danh', 'label' => 'Điểm danh', 'icon' => 'ti tabler-clipboard-check'],
            ['stt' => 3, 'route' => 'admin.diem-danh.cham-cong', 'label' => 'Chấm công', 'icon' => 'ti tabler-clock'],
            ['stt' => 4, 'route' => 'admin.diem-danh.nghi-phep', 'label' => 'Nghỉ phép', 'icon' => 'ti tabler-beach'],
            ['stt' => 5, 'route' => 'admin.tai-chinh.tinh-luong', 'label' => 'Tính lương', 'icon' => 'ti tabler-calculator'],
        ],
    ],
    [
        'stt' => 6,
    ...
    [
        'stt' => 7,
        'type' => 'group',
        'routes' => ['admin.tai-chinh.cong-no', 'admin.tai-chinh.phieu-thu-chi'],
        'route_prefixes' => ['admin.tai-chinh.cong-no', 'admin.tai-chinh.phieu-thu-chi'],
        'label' => 'Tài chính',
        'icon' => 'ti tabler-cash',
        'children' => [
