...
<html
  ...
  <head>
    ...
    <title>Demo: Selects and tags - Forms | Vuexy - Bootstrap Dashboard PRO</title>
            ...
            <div class="col-md-6">
              ...
              <select id="select2Icons" class="select2-icons form-select">
                <optgroup label="Services">
                  <option value="Bootstrap5" data-icon="icon-base ti tabler-brand-bootstrap" selected>Bootstrap 5</option>
                  <option value="codepen" data-icon="icon-base ti tabler-brand-codepen">Codepen</option>
                  <option value="php" data-icon="icon-base ti tabler-brand-php">PHP</option>
                  <option value="pinterest2" data-icon="icon-base ti tabler-brand-css3">CSS3</option>
                  <option value="html5" data-icon="icon-base ti tabler-brand-html5">HTML5</option>
                </optgroup>
                <optgroup label="File types">
                  <option value="pdf" data-icon="icon-base ti tabler-file-description">PDF</option>
                  <option value="word" data-icon="icon-base ti tabler-file-description">Word</option>
                  <option value="js" data-icon="icon-base ti tabler-brand-javascript">JavaScript</option>
                  <option value="facebook" data-icon="icon-base ti tabler-brand-facebook">Facebook</option>
                </optgroup>
                <optgroup label="Browsers">
                  <option value="chrome" data-icon="icon-base ti tabler-brand-chrome">Chrome</option>
                  <option value="firefox" data-icon="icon-base ti tabler-brand-firefox">Firefox</option>
                  <option value="safari" data-icon="icon-base ti tabler-brand-edge">Edge</option>
                  <option value="opera" data-icon="icon-base ti tabler-brand-opera">Opera</option>
                  <option value="Ubuntu" data-icon="icon-base ti tabler-brand-ubuntu">Ubuntu</option>
                </optgroup>
              </select>
            </div>
            <!-- Colors -->
        ...
        <div class="card-body">
          <div class="row g-6">
            ...
            <div class="col-md-6">
              ...
              <button type="button" class="btn btn-sm rounded-pill btn-icon btn-outline-primary mb-1"><span class="icon-base ti tabler-plus"></span></button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card-body">
          <div class="row g-6">
            ...
            <div class="col-md-6">
              ...
              <select class="selectpicker w-100 show-tick" id="selectpickerIcons" data-icon-base="icon-base ti" data-tick-icon="tabler-check" data-style="btn-default">
                <option data-icon="icon-base ti tabler-brand-instagram">Instagram</option>
                <option data-icon="icon-base ti tabler-brand-pinterest">Pinterest</option>
                <option data-icon="icon-base ti tabler-brand-twitch">Twitch</option>
              </select>
            </div>
            <!-- Subtext -->
            <div class="col-md-6">
