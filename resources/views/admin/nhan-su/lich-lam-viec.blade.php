...
@push('styles')
    ...
    <style>
        ...
        .admin-work-calendar .ws-day-contracts {
            display: flex;
            flex-direction: column;
            gap: 3px;
            width: 100%;
        }
        .admin-work-calendar .ws-day-contract {
            position: relative;
            border-radius: 7px;
        ...
        .admin-work-calendar .ws-day-contract__pay .icon-base {
            font-size: .72rem;
            width: .72rem;
            height: .72rem;
        }
        .ws-day-contract__pay--full {
            color: #28c76f;
        }
        .ws-day-contract__pay--zero {
            color: #ea5455;
        }
        ...
        .ws-work-detail-card .ws-day-contract__pay .icon-base {
            font-size: 1rem;
            width: 1rem;
            height: 1rem;
        }
        .admin-work-calendar .ws-day-contract--phan_chup,
        .ws-lich-legend__swatch.ws-day-contract--phan_chup {
            background: #ffe4e8;
            border-left-color: #e53e3e;
        }
        .admin-work-calendar .ws-day-contract--phan_make,
        .ws-lich-legend__swatch.ws-day-contract--phan_make {
            background: #ede9fe;
            border-left-color: #7c3aed;
        }
        .admin-work-calendar .ws-day-contract--phan_edit,
        .ws-lich-legend__swatch.ws-day-contract--phan_edit {
            background: #dbeafe;
            border-left-color: #2563eb;
        }
        .admin-work-calendar .ws-day-contract--up_link_demo,
        .ws-lich-legend__swatch.ws-day-contract--up_link_demo {
            background: #d1fae5;
            border-left-color: #059669;
        }
        .admin-work-calendar .ws-day-contract--up_link_in,
        .ws-lich-legend__swatch.ws-day-contract--up_link_in {
            background: #fef3c7;
            border-left-color: #d97706;
        }
        .ws-lich-legend__item {
            display: inline-flex;
            align-items: center;
            gap: 8px;
            font-size: .8125rem;
        ...
        .ws-lich-legend__label {
            line-height: 1.2;
        }
        .ws-lich-filters .form-check-label {
            font-size: .8125rem;
            cursor: pointer;
        }
        .ws-work-detail-card {
        ...
        .ws-work-detail-card--phan_chup { border-left-color: #e53e3e !important; }
        .ws-work-detail-card--phan_make { border-left-color: #7c3aed !important; }
        .ws-work-detail-card--phan_edit { border-left-color: #2563eb !important; }
        .ws-work-detail-card--up_link_demo { border-left-color: #059669 !important; }
        ...
        .admin-work-calendar .ws-day-contract__more {
            font-size: .69rem;
            font-weight: 700;
            color: #696cff;
            padding: 0 2px 2px;
        }
        .admin-work-calendar .fc-dayGridWeek-view .fc-daygrid-day-frame {
            min-height: 200px;
        }
        .admin-work-calendar .fc-dayGridWeek-view .fc-col-header-cell-cushion {
            font-weight: 600;
            font-size: .8125rem;
        }
        .admin-work-calendar .ws-week-day-header {
            display: flex;
            flex-direction: column;
            align-items: center;
            gap: 2px;
        ...
        .admin-work-calendar .ws-upload-meta {
            display: grid;
            gap: 4px;
        }
        ...
        #wsAddWorkModal .modal-dialog.modal-xl {
            max-width: 1200px;
        }
        #wsAddWorkModal .ws-add-work-field-hop-dong {
            max-width: 100%;
        }
        ...
        #wsAddWorkModal .ws-add-work-field-hop-dong .select2-container {
            width: 100% !important;
            max-width: 100%;
        }
        #ws-lich-lam-viec.is-list-mode .fc-view-harness {
        ...
        .ws-lich-list-card:hover {
            box-shadow: 0 2px 8px rgba(67, 89, 113, .12);
        }
        .ws-lich-list-card--phan_chup { border-left-color: #e53e3e; background: #fffafb; }
        .ws-lich-list-card--phan_make { border-left-color: #7c3aed; background: #faf9ff; }
        .ws-lich-list-card--phan_edit { border-left-color: #2563eb; background: #f8fbff; }
        .ws-lich-list-card--up_link_demo { border-left-color: #059669; background: #f6fffb; }
        .ws-lich-list-card--up_link_in { border-left-color: #d97706; background: #fffdf6; }
        .ws-lich-list-card__body {
            padding: .65rem .75rem .5rem;
        }
        .ws-lich-list-card__head {
            display: flex;
            flex-wrap: wrap;
            align-items: flex-start;
        ...
        .ws-lich-list-card__footer .badge {
            font-size: .75rem;
            font-weight: 600;
        }
        .ws-lich-list-pay {
