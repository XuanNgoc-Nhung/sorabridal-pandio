...
class NhanSuController extends Controller
{
    ...
    /** @return list<string> */
    private function lichLamViecTenRutGonDacBiet(): array
    {
    ...
    private function lichLamViecTenRutGon(string $hoTen): string
    {
        $hoTen = trim($hoTen);
        if ($hoTen === '') {
            return '';
        ...
        $dacBiet = array_map(
            ...
            $this->lichLamViecTenRutGonDacBiet()
        );
    ...
    {
        $rutGonChuRe = $this->lichLamViecTenRutGon(trim((string) ($hd->ten_chu_re ?? '')));
        $rutGonCoDau = $this->lichLamViecTenRutGon(trim((string) ($hd->ten_co_dau ?? '')));
